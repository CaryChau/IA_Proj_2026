...
public class MenuCreator : MonoBehaviour
{
    ...
    {
        currentScrollView = new ScrollView();
        // currentScrollView.
        hasCurrentScrollview = true; 
        m_MenuPanel.Add(currentScrollView);
        currentScrollView.AddToClassList(scrollviewTwoButtonClass);
        createdVisualElements.Add(currentScrollView);
        //Button 1
        var newButton = new Button(menuButton.ButtonAction);
        newButton.text = menuButton.ButtonText;
        currentScrollView.Add(newButton);
        createdVisualElements.Add(newButton);
        menuButton.SetButtonColor(newButton);
        //Button 2
        var newButton2 = new Button(menuButton2.ButtonAction);
        newButton2.text = menuButton2.ButtonText;
        currentScrollView.Add(newButton2);
